...
export class ErrorBoundary extends Component<Props, State> {
  ...
  public render() {
    if (this.state.hasError) {
      return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-neutral-900/90 backdrop-blur-xs text-neutral-100 font-sans">
          <div className="max-w-md w-full bg-neutral-800 border border-neutral-700 rounded-2xl p-6 shadow-2xl space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-400 mt-1">
                {this.state.error?.message || 'Không thể hiển thị giao diện phân hệ.'}
              </p>
            </div>
            <div className="pt-2">
              <button
                ...
                className="w-full py-2.5 px-4 rounded-xl bg-white text-neutral-900 text-xs font-semibold hover:bg-neutral-100 transition-colors cursor-pointer"
              >
                Tải lại ứng dụng
              </button>
            </div>
